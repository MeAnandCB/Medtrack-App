...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final fNkey = GlobalKey<FormState>();
  final phkey = GlobalKey<FormState>();
  final dobkey = GlobalKey<FormState>();
  final genKey = GlobalKey<FormState>();
                      ...
                      children: [
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: "Email ID (please add @gmail.com)",
                            labelText: "Email ID (please add @gmail.com)",
                          ),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: "Password (Must 8 char ex: Abcd@123)",
                            labelText: "Password (Must 8 char ex: Abcd@123)",
                          ),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
