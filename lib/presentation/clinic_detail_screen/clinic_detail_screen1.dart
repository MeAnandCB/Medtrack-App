...
class ClinicDetailsPage2 extends StatefulWidget {
  const ClinicDetailsPage2({Key? key}) : super(key: key);

  @override
  _ClinicDetailsPage2State createState() => _ClinicDetailsPage2State();
}

class _ClinicDetailsPage2State extends State<ClinicDetailsPage2>
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 20),
                        Text(
                          DatabaseImages.clinics[1]['name'].toString(),
                          style: TextStyle(
                            fontSize: 18,
                        ...
                        Text(
                          DatabaseImages.clinics[1]['specialty'].toString(),
                          style: TextStyle(
                            color: ColorCOnstant.myWhite,
                            height: 1.5,
                          ),
