...
class DoctorsDetailsPage5 extends StatefulWidget {
  const DoctorsDetailsPage5({Key? key}) : super(key: key);

  @override
  _DoctorsDetailsPage5State createState() => _DoctorsDetailsPage5State();
}

class _DoctorsDetailsPage5State extends State<DoctorsDetailsPage5>
