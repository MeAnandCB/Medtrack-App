...
class ClinicDetailsPage4 extends StatefulWidget {
  const ClinicDetailsPage4({Key? key}) : super(key: key);

  @override
  _ClinicDetailsPage4State createState() => _ClinicDetailsPage4State();
}

class _ClinicDetailsPage4State extends State<ClinicDetailsPage4>
            ...
            child: Stack(
              children: [
                Container(
                  height: 400,
                  child: Image.network(
                    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRA0IrGQOfQa-euopliUjVFNYX6EJ4W7IWeWPid9_uBOKHg_LFEMvyyJHc3RMagc67R3t0&usqp=CAU",
                    fit: BoxFit.cover,
                  ),
                ),
                Positioned(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 20),
                        Text(
                          DatabaseImages.clinics[4]['name'].toString(),
                          style: TextStyle(
                            fontSize: 18,
                        ...
                        Text(
                          DatabaseImages.clinics[4]['specialty'].toString(),
                          style: TextStyle(
                            color: ColorCOnstant.myWhite,
                            height: 1.5,
                          ),
