            ...
            child: Stack(
              children: [
                Container(
                  height: 400,
                  child: Image.network(
                    "https://content.jdmagicbox.com/comp/ernakulam/d4/0484px484.x484.190209205517.u5d4/catalogue/casa-blanca-the-clinic-cochin-special-economic-zone-ernakulam-clinics-smkwgf350s.jpg",
                    fit: BoxFit.cover,
                  ),
                ),
                Positioned(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 20),
                        Text(
                          DatabaseImages.clinics[0]['name'].toString(),
                          style: TextStyle(
                            fontSize: 18,
                        ...
                        Text(
                          DatabaseImages.clinics[0]['specialty'].toString(),
                          style: TextStyle(
                            color: ColorCOnstant.myWhite,
                            height: 1.5,
                          ),
