...
class ClinicDetailsPage5 extends StatefulWidget {
  const ClinicDetailsPage5({Key? key}) : super(key: key);

  @override
  _ClinicDetailsPage5State createState() => _ClinicDetailsPage5State();
}

class _ClinicDetailsPage5State extends State<ClinicDetailsPage5>
            ...
            child: Stack(
              children: [
                Container(
                  height: 400,
                  child: Image.network(
                    "https://www.drvarshaliclinic.com/assets/images/pages/updates/2021/09-Sep/01-Our-clinic-new-design/our-clinic-richer-experience-for-visitors-dr-varshali-gynecology-clinic-feature-image.jpg",
                    fit: BoxFit.cover,
                  ),
                ),
                Positioned(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 20),
                        Text(
                          DatabaseImages.clinics[2]['name'].toString(),
                          style: TextStyle(
                            fontSize: 18,
                        ...
                        Row(
                          children: [
                            for (int i = 1;
                                i <= DatabaseImages.clinics[3]['rating'];
                                i++)
                              Icon(
                                Icons.star,
                                color: Colors.amber,
                        ...
                        Text(
                          DatabaseImages.clinics[2]['specialty'].toString(),
                          style: TextStyle(
                            color: ColorCOnstant.myWhite,
                            height: 1.5,
                          ),
