...
class DoctorsDetailsPage2 extends StatefulWidget {
  const DoctorsDetailsPage2({Key? key}) : super(key: key);

  @override
  _DoctorsDetailsPage2State createState() => _DoctorsDetailsPage2State();
}

class _DoctorsDetailsPage2State extends State<DoctorsDetailsPage2>
            ...
            child: Stack(
              children: [
                Container(
                  height: 400,
                  child: Image.network(
                    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzGrAi7gbjev8VmjSoDppqldgsBNdCJn9l8k_iiE4LV9ApMAtQCbayVhHYv_xafgwOCME&usqp=CAU",
                    fit: BoxFit.cover,
                  ),
                ),
                Positioned(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 20),
                        Text(
                          DatabaseImages.doctorsClinic[1]['name'].toString(),
                          style: TextStyle(
                            fontSize: 18,
                        ...
                        Text(
                          DatabaseImages.doctorsClinic[1]['specialty']
                              .toString(),
                          style: TextStyle(
                            color: ColorCOnstant.myWhite,
                            height: 1.5,
